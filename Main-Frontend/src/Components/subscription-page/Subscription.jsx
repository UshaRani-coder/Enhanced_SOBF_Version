...
const Subscription = () => {
  ...
  return (
    <div className="pt-28 bg-gray-50 py-12 mt-10">
      <div className="max-w-4xl mx-auto px-4">  {/* want to demonstrate Instagram reels, please add -- flex flex-col items-center -- styling*/}
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row sm:gap-2 md:gap-0 items-start justify-between lg:flex-col">
                  <img
                    src={QRCode}
                    alt="QR Code"
                    className="size-72 mb-5 lg:mb-12"
                  />
...
{/* 
        <div className="mt-6 flex gap-7">
          <InstagramEmbed postUrl="https://www.instagram.com/reel/DIqTCi5No2e/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" />
          <InstagramEmbed postUrl="https://www.instagram.com/reel/DIjG-ExtYdd/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" />
        </div> */}
      </div>
    </div>
  );
