      ...
      {service === null && (
        <ul className="services w-[100%]  mt-[20px] flex flex-col items-center gap-y-[30px] md:gap-y-[70px]  md:flex-row  md:justify-center md:gap-x-[60px] lg:gap-x-[30px]  md:flex-wrap">
          ...
          <li
            data-aos="fade-right"
            data-aos-delay="100"
            className="service service1 rounded-tl-[50px] rounded-br-[50px] cursor-pointer bg-[#73002e]  w-[80%] md:w-[35%] lg:w-[25%] relative overflow-hidden h-[300px] flex flex-col items-center justify-center"
            onClick={() => {
          ...
          <li
            ...
            data-aos-delay="100"
            onClick={() => {
              setService('gopalaBhog');
              scrollToServices();
            }}
            className="service service2 rounded-tl-[50px] rounded-br-[50px] cursor-pointer bg-[#ee9904]   w-[80%] md:w-[35%] lg:w-[25%] relative overflow-hidden h-[300px] flex flex-col items-center justify-center"
          >
            <div className="service-content relative z-40 h-full cursor-pointer flex flex-col items-center justify-center ">
              ...
              <p className="pt-[5px] text-center text-[16px] lg:text-[18px]  px-[20px] text-[#ffffff]">
          ...
          <li
            ...
            data-aos-delay="100"
            onClick={() => {
              setService('brajkulamEducationalCenter');
              scrollToServices();
            }}
            className="service service3 rounded-tl-[50px] rounded-br-[50px] cursor-pointer bg-[#00a6e9]   w-[80%] md:w-[35%] lg:w-[25%] relative overflow-hidden h-[300px] flex flex-col items-center justify-center"
          >
            <div className="px-[20px] service-content relative z-40 h-full cursor-pointer flex flex-col items-center justify-center ">
              <svg
              ...
              <h2 className="text-center  text-[20px]  text-[#ffffff] font-bold">
                Brajkulam Community Center
              </h2>
              <p className="pt-[5px] text-center text-[16px]  lg:text-[18px] ] text-[#ffffff]">
          ...
          <li
            ...
            data-aos-delay="100"
            onClick={() => {
              setService('swachh&SwasthVrindavan');
              scrollToServices();
            }}
            className="service service4 rounded-tl-[50px] rounded-br-[50px] cursor-pointer bg-[#00a36c]   w-[80%] md:w-[35%] lg:w-[25%] relative overflow-hidden h-[300px] flex flex-col items-center justify-center"
          >
            <div className="px-[20px] service-content relative z-40 h-full cursor-pointer flex flex-col items-center justify-center ">
              <svg
          ...
          <li
            ...
            data-aos-delay="100"
            onClick={() => {
              setService('sadhuSeva');
              scrollToServices();
            }}
            className="service service5 rounded-tl-[50px] rounded-br-[50px] cursor-pointer bg-orange   w-[80%] md:w-[35%] lg:w-[25%] relative overflow-hidden h-[300px] flex flex-col items-center justify-center"
          >
            <div className="px-[20px] service-content relative z-40 h-full cursor-pointer flex flex-col items-center justify-center ">
              <svg
                className="h-[40px] w-[40px] "
		...
		s-3.73,8.34-8.34,8.34s-8.34-3.73-8.34-8.34S95.83,20.5,100.44,20.5L100.44,20.5z"
              ...
              <h2 className="text-center text-[20px]  text-[#ffffff] font-bold px-[10px]">
                Health and Awareness Camp
              </h2>
              <p className="pt-[5px] text-center text-[16px] lg:text-[18px] lg:pt-[10px]  px-[20px] text-[#ffffff]">
