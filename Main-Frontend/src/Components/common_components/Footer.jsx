...
import { handleRedirectCall, handleRedirectFacebook, handleRedirectInstagram, handleRedirectLinkedIn, handleRedirectMail, handleRedirectMap, handleRedirectWhatsapp, handleRedirectYoutube } from '@/utils/SOBF_Map';
