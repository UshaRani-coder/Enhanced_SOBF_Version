...
const Footer = () => {
  ...
  const handleRedirectMail = () =>
    window.open('mailto:soulofbraj@gmail.com', '_blank');
  const handleRedirectCall = () => window.open('tel:+91 8439406670', '_blank');
  const handleRedirectFacebook = () =>
    window.open('https://www.facebook.com/soulofbraj/', '_blank');
  const handleRedirectInstagram = () =>
    window.open('https://www.instagram.com/soulofbraj/?hl=en', '_blank');
  const handleRedirectWhatsapp = () =>
    window.open('https://wa.me/918439406670', '_blank');
  const handleRedirectLinkedIn = () =>
    window.open('https://www.linkedin.com/company/soulofbraj/', '_blank');
  const handleRedirectYoutube = () =>
            ...
            <div className="lg:col-span-4">
              ...
              <Link onClick={handleRedirectMap}>
                <p className="mb-4 flex items-center justify-center md:justify-start hover:text-gray-300">
                  ...
                  Soul of Braj Federation Chaitnya Vihar Phase-2, Plot No :
                  9-10, Near Electric Sub Station, Durga Mandir, Vrindavan,
                  UttarPradesh 281121
                </p>
              </Link>
            ...
            <div className="lg:col-span-8">
              <div className="flex justify-start lg:ml-[20%]">
                <div className="grid grid-cols-1 gap-20 sm:gap-20 sm:grid-cols-2">
                  ...
                  >
                    <h3
                      className="mb-6 text-base font-medium text-gray-200 text-[20px]"
