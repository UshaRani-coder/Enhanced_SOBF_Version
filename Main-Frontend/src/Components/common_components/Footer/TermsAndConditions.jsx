      ...
      <div className="flex flex-col lg:flex-row items-center lg:justify-center lg:gap-x-[30px] xl:gap-x-[100px] gap-y-[10px]">
        <div className="flex flex-col items-center md:items-center mx-[20px] w-[90%] lg:w-[70%] justify-center">
          ...
          <div className="text-gray-700  text-[16px] lg:text-[18px] mt-2 font-workSans xl:mt-0 pb-[30px] lg:leading-[30px]">
            ...
            <h2 className="text-xl font-semibold mt-5 mb-3 text-black">
              USE OF CONTENT
            </h2>
            ...
            <p className="mb-4">
              ...
              from or resulting from their use of{' '}
              <a
                href="www.soulofbrajfederation.org"
            ...
            <p className="mb-4">
              ...
              shall Company's total liability to the User for all damages or/and
              losses or/and causes of action exceed the amount paid by the User
              to Company, if any, that is related to the cause of action.
            </p>
