        ...
        <div className="flex flex-col items-center md:items-center mx-[20px] w-[90%] lg:w-[70%] justify-center">
          ...
          <div className="text-gray-700  text-[16px] lg:text-[18px] mt-2 font-workSans xl:mt-0 pb-[30px] lg:leading-[30px]">
            ...
            <p>
              ...
              (both terms defined below). The terms of this Privacy Policy will
              be effective upon your acceptance of the same (directly or
              indirectly in electronic form, by clicking on the I accept tab or
              ...
              <strong style={{ color: '#000' }}>"Website"</strong> (defined
              below).
            </p>
            ...
            <p>
              ...
              above-said user information to maintain, protect, and improve our
              services (including advertising services) and for developing new
              services. Such information will not be considered as sensitive if
            ...
            <p>
              Our policy discloses the privacy practices for our own website
              only. Our site provides links to other websites that are beyond
              our control. We shall in no way be responsible for your use of
              such sites.
            </p>
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                ...
                and officers and employees of such group companies for the
                purpose of processing personal information on its behalf.
              </li>
            </ul>
            ...
            <p>
              <strong>
                <a href="http://www.soulofbrajfederation.org">
                  www.soulofbrajfederation.org
                </a>
              </strong>
            </p>
            <p>
              <strong>SOUL OF BRAJ FEDERATION</strong>
              <br />
              <strong>Sri Krishna Greens</strong>
              <br />
              <strong>Vrindavan, Mathura</strong>
              <br />
              <strong>Pin-281121</strong>
              <br />
              <strong>
                Email:{' '}
                <a href="mailto:soulofbrajfederation@gmail.com">
                  soulofbrajfederation@gmail.com
                </a>
              </strong>
              <br />
