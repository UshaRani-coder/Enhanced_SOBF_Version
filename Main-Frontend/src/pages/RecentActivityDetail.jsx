...
const RecentActivityDetails = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full mt-[100px] md:mt-[140px]  p-4">
      <h1 className="text-2xl md:text-3xl font-bold text-center mb-4 md:mb-[30px]">{activity.title}</h1>
      <div className="flex flex-col lg:flex-row w-full lg:gap-[20px]">
      <div className={`w-full lg:w-[60%] ${activity.images?.length === 1 ? "" : "grid grid-cols-1 md:grid-cols-2 gap-4"}`}>
  {activity.images && activity.images.length > 0 ? (
    ...
    />
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-start p-4">
          <div className="text-sm text-gray-500 mb-4 flex items-center gap-x-[5px]"><svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="w-[10px]"
                >
                  <path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                </svg> {formatDate(activity.date)}</div>
