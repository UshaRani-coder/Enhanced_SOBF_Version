...
export const createAdmin = (adminData) =>
  api.post('/api/admin/create-admin', adminData);
export const updateAdmins = (id, updatedAdmin) =>
  api.put(`/api/admin/update-admin/${id}`, updatedAdmin);
...
export const createPost = (postData) =>
  api.post('/api/post/create-post', postData);
export const updatePostApi = (id, updatedPost) =>
  api.put(`/api/post/update/${id}`, updatedPost);
