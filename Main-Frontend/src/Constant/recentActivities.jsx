...
const recentActivities = [
  ...
  },
  {
    ...
    description:
      'The Brajkulam Community Center is dedicated to nurturing young minds and shaping the future of the Braj region. This center provides quality education and skill training to children and youth, empowering them with the knowledge and tools needed to thrive in today’s world. ',
    button: 'Click here to Read More',
  },
  {
    id: 31,
    ...
    description:
      'Our women empowerment program equips women with skills like tailoring and crafts, fostering confidence. By enabling them to build brighter futures, this initiative uplifts individuals and communities, paving the way for a more empowered and self-reliant Braj region.',
    button: 'Click here to Read More',
  },
];
