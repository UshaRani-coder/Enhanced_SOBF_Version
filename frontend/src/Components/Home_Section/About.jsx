...
import aboutImg from "../../assets/Sobf Images/children_activities/ca17.jpg";
...
const About = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center lg:text-start lg:flex lg:flex-row lg:justify-center lg:items-center lg:gap-x-[20px] z-40  mt-5 lg:px-[40px] lg:pb-[50px]">
        <p className=" leading-[27px] text-heading5 md:text-[18px] lg:text-[15px] lg:leading-[24px] text-[rgba(225,225,225,0.85)]   mt-4 mx-4 lg:m-0 ">
          <span className="text-xl text-violet-700 font-bold hover:underline">
          ...
          Basis.
          <br />
          <div className="text-violet-700 mt-[20px] lg:mt-0 font-bold text-xl">
        ...
        <img
          src={aboutImg}
          alt="about"
          className="z-40 my-[30px] lg:my-0 w-[95%] lg:w-[40%] lg:h-[300px] xl:h-[280px] xl:pt-[25px]"
        />
      </div>
    </div>
  );
