...
const About = () => {
  return (
    ...
    >
      ...
      <div className=" md:mb-10 flex flex-col items-center  lg:flex lg:flex-row lg:justify-center lg:items-center lg:gap-x-[50px] z-40  mt-5 lg:px-[40px] xl:justify-around pb-[30px]">
