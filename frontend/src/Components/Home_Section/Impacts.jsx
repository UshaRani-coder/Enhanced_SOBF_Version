...
const Statistics = () => {
  ...
  return (
    <>
      <div className="w-[90%] ">
        <h1 className="text-center text-heading3 lg:text-heading2 font-bold  p-5 text-[#2d335d] ">
          Our Impacts
        </h1>
      </div>

      <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-8 ">
        <ul className="w-full lg:px-[70px]  xl:px-0 flex flex-col items-center md:flex-row md:justify-center md:flex-wrap  gap-4">
          {/* List items */}
          <li className="flex flex-col items-center p-6 xl:py-[23px] rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            ...
            <span className="font-bold text-3xl md:text-3xl lg:text-4xl mt-4 text-[#333]">
              <Number n={15000} />
            </span>
            <p className="text-center text-base mt-2 text-[#666]">
              Food distribution
            </p>
          </li>
          ...
          <li className="flex flex-col items-center p-6 xl:py-[23px] rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            ...
            <span className=" font-bold text-3xl md:text-3xl lg:text-4xl mt-4">
              <Number n={12000} />
            </span>
          ...
          {/* Total lives reached */}
          <li className="flex flex-col items-center px-4 py-6 md:p-6 rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            <svg
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Villages reached */}
          <li className="flex flex-col items-center p-6 md:px-[25px] rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            <svg
              id="Layer_1"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Donation received */}
          <li className="flex flex-col items-center px-4 py-6 md:px-4 rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300flex flex-col items-center p-6 rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            <svg
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
        ...
        c0.81-3.02-0.99-6.14-4.02-6.95l3.93-14.68C48.89,13.68,52.02,11.88,52.83,8.85L52.83,8.85z M0,47.3h24.83v44.18H0V47.3L0,47.3z"
          ...
          {/* Volunteers */}
          <li className="flex flex-col items-center px-[40px] py-6 md:px-[50px] rounded-xl bg-white shadow-neumorphic-light border border-[#e0e0e0] hover:shadow-neumorphic-dark transition-all ease-in-out duration-300">
            <svg
              version="1.1"
              id="Layer_1"
              x="0px"
