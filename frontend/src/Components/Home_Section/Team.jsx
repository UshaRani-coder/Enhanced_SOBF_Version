  ...
  return (
      ...
      <div className=" mt-[100px] team-cards flex flex-col items-center gap-[50px] justify-center md:flex-row md:flex-wrap md:w-[80%]  md:gap-x-[100px] md:gap-y-[40px] lg:gap-y-[60px] lg:gap-x-[200px]">
        ...
        <div className="flex items-center flex-col gap-y-[5px] md:w-[300px]">
          ...
          <div className="flex flex-col gap-y-[10px] items-center">
            ...
            <div className="socials flex gap-x-[10px] ">
              <Link to={'https://www.linkedin.com/in/d-r-opt-shalu-sharma-353b70202/'}>
              <div className="bg-[#374151] p-[5px]  rounded-full hover:scale-[1.2] cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
   ...
   <div className="flex items-center flex-col gap-y-[5px] md:w-[300px]">
          <div
            className="w-[200px] h-[200px]   rounded-full"
            style={{
              backgroundImage: `url(${MarkRameshRamdeen})`,
              backgroundPosition: "center",
              backgroundSize: "cover",
              backgroundRepeat: "no-repeat",
            }}
          ...
          <div className="flex flex-col gap-y-[10px] items-center">
            <div className="flex flex-col items-center  ">
              ...
              at{" "}
                ...
                <p className="text-[12px] mx-[10px] md:mx-0 lg:text-[14px] font-workSans text-[rgba(255,255,255,0.5)]">CEO & Founder- Indian Bureaucracy</p>
              </p>
