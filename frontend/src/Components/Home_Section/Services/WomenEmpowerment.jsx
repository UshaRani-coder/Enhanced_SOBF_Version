...
import womenEmpowermentImg from "../../../assets/Sobf Images/women empowerment/we3.avif";
    ...
    <div className="w-full md:w-[90%] flex flex-col items-center lg:items-start mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:justify-center lg:gap-x-[30px] xl:gap-x-[100px] gap-y-[10px]">
        ...
        <div className="flex flex-col md:items-start items-center mx-[20px] w-[90%] lg:w-[50%] justify-center">
          <h1 className="text-center text-heading4 lg:text-[27px] xl:text-heading3 font-bold my-4  relative  transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-gray-400 before:origin-center before:h-[1px] before:w-0 hover:before:w-[50%] before:bottom-0 before:left-[50%] after:transition-[width] after:ease-in-out after:duration-700 after:absolute after:bg-gray-400 after:origin-center after:h-[1px] after:w-0 hover:after:w-[50%] after:bottom-0 after:right-[50%]">
            Women Empowerment
          </h1>
          <p className="text-gray-700 text-[16px] text-justify lg:text-[18px] mt-2 font-workSans xl:mt-0 xl:pb-[50px]  lg:leading-[30px]">
            We are deeply committed to women empowerment
            through its comprehensive skill development programs. By equipping
            women with essential skills and vocational training, the
            organization enables them to become self-reliant and economically
            independent. These initiatives have already benefited countless
            women in the Braj region, empowering them to take charge of their
            futures and contribute meaningfully to their communities. The
            Federation&lsquo;s efforts continue to uplift and transform the lives of
            its beneficiaries, fostering a brighter and more empowered tomorrow.
          </p>
          <button>
            <Link
              href=""
