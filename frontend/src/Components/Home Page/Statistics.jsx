...
const Statistics = () => {
  return (
    <div className="statistics py-[30px] my-[50px] md:py-0 lg:py-[20px] md:my-0 shadow-dual md:text-[10px]  rounded-lg font-semibold bg-[#ffffff] w-[100%] flex flex-col items-center md:flex-row md:w-[95%] xl:w-[80%]">
      <ul className=" w-[60%] flex flex-col items-center gap-y-[20px] md:flex-row md:items-center md:justify-center md:gap-x-[10px] lg:gap-x-[15px] md:w-[100%] ">
        <li className="flex flex-col items-center">
          ...
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Food Distribution</p>
        </li>
        <li className="flex flex-col items-center md:pt-[10px] lg:pt-0">
          <svg
            id="Layer_1"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-[#ff7700] font-bold text-[20px] md:text-[12px] lg:text-[20px]">12000+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Sanitary Napkins Distributed</p>
        </li>
        <li className="flex flex-col items-center md:pt-[10px] lg:pt-0">
          <svg
            version="1.1"
          ...
          <span className="text-[#ff7700] font-bold text-[20px] md:text-[12px] lg:text-[20px]">15000+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Total Lives Reached</p>
        </li>
        <li className="flex flex-col items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-[#ff7700] font-bold text-[20px] md:text-[12px] lg:text-[20px]">200+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Volunteers</p>
        </li>
        <li className="flex flex-col items-center">
          <svg
            version="1.1"
          ...
          <span className="text-[#ff7700] font-bold text-[20px] md:text-[12px] lg:text-[20px]">75000+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Donation Received</p>
        </li>
        <li className="flex flex-col items-center">
          <svg
            id="Layer_1"
          ...
          <span className="text-[#ff7700] font-bold text-[20px] md:text-[12px] lg:text-[20px]">150+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Village Reached</p>
        </li>
      </ul>
    </div>
  );
