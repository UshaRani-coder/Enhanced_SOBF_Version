    ...
    <div className="statistics py-[30px] my-[50px]  md:py-0 md:my-0 shadow-dual md:text-[10px] lg:text-[16px] rounded-lg font-semibold bg-[#ffffff] w-[100%] flex flex-col items-center md:flex-row md:absolute md:top-[560px]  lg:top-[600px]  md:w-[95%]">
      <ul className=" w-[60%] flex flex-col items-center gap-y-[20px] md:flex-row md:items-center md:justify-center md:gap-x-[10px] lg:gap-x-[15px] md:w-[100%] ">
        <li className="flex flex-col items-center">
          ...
          <span className="text-[#ff7700] font-bold">15000+</span>
          <p className="w-[180px] md:w-[100px] lg:w-[150px] text-center">Food Distribution</p>
        </li>
        <li className="flex flex-col items-center md:pt-[10px] lg:pt-[20px]">
          <svg
            id="Layer_1"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-[#ff7700] font-bold">12000+</span>
        ...
        <li className="flex flex-col items-center">
          ...
          <span className="text-[#ff7700] font-bold">200+</span>
        ...
        <li className="flex flex-col items-center">
          ...
          <span className="text-[#ff7700] font-bold">75000+</span>
        ...
        <li className="flex flex-col items-center">
          ...
          <span className="text-[#ff7700] font-bold">150+</span>
