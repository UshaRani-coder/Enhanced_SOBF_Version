...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-6 lg:top-1 z-50 flex justify-center mt-10">
      <nav className="cursor-pointer w-full bg-white shadow-2xl">
        <div className="container mx-auto flex justify-between items-center p-3">
          ...
          <ul className={`nav-items ${isActive ? "flex" : "hidden"} md:flex  flex-col z-50 md:flex-row items-center gap-4 md:gap-x-10 absolute md:static top-full left-0 w-full md:w-auto bg-white border border-t-2 md:border-none lg:border-none shadow-2xl lg:shadow-none md:bg-transparent p-4 md:p-0`}>
            <li>
            ...
            <li className="block md:hidden">
              <Link to="" className="px-8 py-3.5 mt-6 relative rounded group overflow-hidden font-medium bg-peacock-green text-white inline-block">
                <span className="absolute top-0 left-0 w-0 h-full transition-all duration-300 ease-out transform bg-peacock-green-hover group-hover:w-full"></span>
          ...
          <div className="hidden md:block">
            <Link href="" className="px-8 py-3.5 relative rounded group overflow-hidden font-medium bg-peacock-green text-white inline-block">
              <span className="absolute top-0 left-0 w-0 h-full transition-all duration-300 ease-out transform bg-peacock-green-hover group-hover:w-full"></span>
              <span className="relative z-10">
                <NavLink to="/donate-us" onClick={closeMenu}>Donate</NavLink>
              </span>
