const Footer = () => {
  return (
    <footer className="text-start text-slate-500 w-full">
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div className="lg:col-span-4">
              ...
              {/* Address below logo*/}
              <a href="https://maps.app.goo.gl/6kemecjbb1zUpebt5" target="_blank">
              ...
              {/* Email below logo */}
              <a href="mailto:soulofbraj@gmail.com" target="_blank">
      ...
      {/* Facebook */}
      <a href="https://www.facebook.com/soulofbraj/" target="_blank"
      ...
      {/* Instagram */}
      <a href="https://www.instagram.com/soulofbraj/?hl=en" target="_blank"
      class="p-2 rounded-lg flex items-center border bg-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 71 72"
      fill="none">
      <path
      ...
      {/* Whatsapp */}
      <a href="https://wa.me/918439406670" target="_blank" rel="noopener noreferrer"
      class="p-2 rounded-lg flex items-center border bg-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 71 72"
      fill="none">
      <path
      ...
      {/* LinkedIn */}
      <a href="https://www.linkedin.com/company/soulofbraj/" target="_blank"
      class="p-2 rounded-lg flex items-center border bg-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 72 72"
      fill="none">
      <path
     ...
     {/* Telegram */}
      {/* <a href="https://t.me/918439406670" target="_blank" rel="noopener noreferrer"
      class="p-2 rounded-lg flex items-center border bg-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 72 72"
      fill="none">
      <path
      ...
      {/* Youtube */}
      <a href="https://www.youtube.com/@sobf" target="_blank"
      class="p-2 rounded-lg flex items-center border bg-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
