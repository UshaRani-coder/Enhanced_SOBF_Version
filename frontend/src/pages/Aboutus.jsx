    ...
    <div className='pt-[110px]'>
      ...
      <div className="w-full flex justify-center items-center flex-col lg:flex-row gap-1 lg:gap-5 mx-auto py-8 px-4">
        <div className='w-[98%] lg:w-[50%] '>
          <h2 className="text-logoYellow poppins-semibold text-heading4">What We Do</h2>
        ...
        <div className="w-[99%] lg:w-[50%] mt-4">
          <div className="flex ">
            <button
              className={`poppins-medium w-[33.3%] px-4 py-3 rounded-tl-lg text-sm lg:text-lg ${activeTab === 'mission' ? 'text-white bg-peacock-green-hover' : 'bg-light-lavender text-gray-700'}`}
              onClick={() => setActiveTab('mission')}
            >
              Our Mission
            </button>
            <button
              className={`poppins-medium w-[33.3%] px-4 py-3 text-sm lg:text-lg  ${activeTab === 'vision' ? 'text-white hover:bg bg-peacock-green-hover' : 'bg-light-lavender text-gray-700'}`}
              onClick={() => setActiveTab('vision')}
            >
              Our Vision
            </button>
            <button
              className={`poppins-medium w-[33.3%] px-4 py-3 rounded-tr-lg text-sm lg:text-lg  ${activeTab === 'objective' ? 'text-white bg-peacock-green-hover ' : 'bg-light-lavender text-gray-700'}`}
