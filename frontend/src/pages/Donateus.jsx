    ...
    <div>
      ...
      <div className="flex flex-col justify-center mb-10 px-4 sm:px-6 lg:px-8 ">
        <ul className="w-full grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 lg:gap-6 gap-4">
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            ...
            <svg
              ...
              className="w-12 h-12 text-[#001d23] group-hover:text-[#379e90]"
            >
              {/* SVG path */}
            ...
            <span className="text-[#379e90] font-bold text-3xl md:text-3xl lg:text-4xl mt-4">
              <Number n={15000} />
            </span>
            <p className="text-center text-base mt-2">Food distribution</p>
          </li>
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            <svg
              ...
              className="w-[40px] text-[#001d23] group-hover:text-[#379e90]"
              fill="currentColor"
            >
            ...
            <p className="text-center text-base mt-2">Sanitary napkins</p>
          </li>
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            ...
            <p className="text-center text-base mt-2">Total lives reached</p>
          </li>
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            <svg
              ...
              fill="currentColor"
              className="w-[45px] text-[#001d23] group-hover:text-[#379e90]"
            >
            ...
            <p className="text-center text-base mt-2">Villages reached</p>
          </li>
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            <svg
              ...
              fill="currentColor"
              className="w-[60px] text-[#001d23] group-hover:text-[#379e90]"
            >
              <path
        ...
        c0.81-3.02-0.99-6.14-4.02-6.95l3.93-14.68C48.89,13.68,52.02,11.88,52.83,8.85L52.83,8.85z M0,47.3h24.83v44.18H0V47.3L0,47.3z"
            ...
            <p className="text-center text-base mt-2">Donation received</p>
          </li>
          ...
          <li className="flex flex-col items-center group p-6 rounded-xl hover:shadow-xl">
            ...
            <p className="text-center text-base mt-2">Volunteers</p>
          </li>
        </ul>
      </div>
