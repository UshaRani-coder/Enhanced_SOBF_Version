        ...
        <ul className="space-y-2">
          <li>
            <Link
              ...
              className={`flex items-center pt-2 pb-2  w-[90%] ${
          ...
          <li>
            <Link
              ...
              className={`flex items-center pb-2 pt-2 w-[90%] ${
                location.pathname === '/hero-banner'
                  ? 'text-white bg-[rgb(39,39,79)]'
                  : 'text-[rgba(255,255,255,0.7)]'
              } hover:text-white hover:bg-[rgb(39,39,79)] rounded`}
            >
          ...
          <li>
            <Link
              ...
              onClick={onOptionClick}
              className={`flex items-center pb-2 pt-2 w-[90%] ${
                location.pathname === '/featured-videos'
                  ? 'text-white bg-[rgb(39,39,79)]'
                  : 'text-[rgba(255,255,255,0.7)]'
              } hover:text-white hover:bg-[rgb(39,39,79)] rounded`}
            >
