...
//     try {
//       await dispatch(addTeam(newTeam)).unwrap(); // Wait for action to complete
...
//     dispatch(
//       updateTeamData({ id: currentPost._id, updatedData: updatedTeam })
//     );
...
const Team = () => {
  ...
  const handleUpdateTeamMember = async() => {
    ...
    try {
      ...
      const result = await dispatch(updateTeamData({ id: currentPost?._id, teamData: updatedTeam })).unwrap();
